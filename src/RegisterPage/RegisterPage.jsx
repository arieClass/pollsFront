...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if (user.gender && user.city && user.birthDate && user.secret &&  user.username && user.password) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    <div className={'form-group' + (submitted && !user.gender ? ' has-error' : '')}>
                        ...
                        <select name="gender" className="form-control" defaultValue="male" onChange={this.handleChange}>
                    ...
                    <div className={'form-group' + (submitted && !user.secret ? ' has-error' : '')}>
                        <label htmlFor="secret">Secret</label>
                        <input type="password" className="form-control" name="secret" value={user.secret} onChange={this.handleChange} />
                        {submitted && !user.secret &&
                            <div className="help-block">Secret is required</div>
                        }
                    </div>
